...
sc = ax1.scatter(
    surf_lh.vertices[idx, 0],
    surf_lh.vertices[idx, 1],
    surf_lh.vertices[idx, 2],
    c=thickness[idx], cmap="YlOrRd", s=0.3, vmin=1, vmax=4,
)
...
sc2 = ax2.scatter(
    ...
    surf_lh.vertices[idx, 1],
    surf_lh.vertices[idx, 2],
    c=curvature[idx], cmap="RdBu_r", s=0.3, vmin=-0.5, vmax=0.5,
)
